...
public class C02_TwicePrint {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------------------------"); 
		System.out.println("사나\t1996.12.29\t27"); //한개의 문자열을 출력
		System.out.println("지효\t1997.02.01\t26");
		System.out.println("미나\t1998.03.24\t25");
		
		// printf() 메소드 사용해서 출력형식을 지정함.
	 ...
	 *
	 *\(역슬래쉬) 사용하는 이스케이프 문자 : \n (줄바꿈) , \t(tab)
	 *형식지정문자 %기호 사용 : %s(정수) 자리수를 지정해서 쓸 수 있다.
	 *						ㄴ 남은 자리 0으로 채울때에는 %03d 와 같이 합니다.
	 *""안에 들어가있는 문자는 정수가 아니다 무조건 문자로 읽는다.
	 */
