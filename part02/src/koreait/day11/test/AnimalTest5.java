...
public class AnimalTest5 {
	...
	public static void main(String[] args) {
		...
		System.out.println("현재 시간을 알려드립니다.");
		System.out.println(System.currentTimeMillis()+ "ms");		// 0.001초
		System.out.println(System.nanoTime()+ "ns");				// 0.0000000001초
		
		
		
		// 개구리가 몇 마리인지....instanceof
		int cnt = 0; // 카운트 변수
		long start = System.nanoTime();	// 현재 시간을 ns(0.0000000001초)
		...
		System.out.println("개구리 먹이 주는데 걸린 시간 :" + (end - start) + "ms");
		System.out.println("개구리는" + cnt + "마리 살고 있습니다.");
		
		//강아지가 몇 마리인지...int type 필드 이용해서 합니다.
		...
		System.out.println("강이지 먹이 주는데 걸린 시간 :" + (end - start) + "ms");
...
//			super.act();	//부모클래스의 act() 실행
			System.out.println("개구리 행동 : 수시로 점핑하기 ");
	}
	@Override
...
class Cat extends Animal{
	...
	@Override
	public void act() {
		System.out.println("고양이 행동 : 수시로 야옹야옹 울기 ");
	}
