...
// sort 와 관련된 인터페이스 사용.
	public static void main(String[] args) {
		...
		// 다향성 : List를 참조타입으로 하여 선언한다. 앞으로 배울 라이브러리들이 List타입으로 원한다.
		...
		ilist.sort(null);	// 인자로 필요한 것은 비교자 Comparator 구현체 필요합니다.
							// 기본형, String은 null 로 할 수 있다. (오름차순 기본)
		System.out.println("sort 이후 : " + ilist);
		ilist.sort(Comparator.reverseOrder());		// reverse : 역순(내림차순), Comparator 인터페이스의 static 메소드
