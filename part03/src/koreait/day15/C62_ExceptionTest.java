...
// : Error	-> 시스템 상의 오류(HW, OS, JVM ...)
// : Excetion	-> 개발중인 프로그램과 관련된 문제
public class C62_ExceptionTest {

	public static void main(String[] args) {
		
		//Exception 예시1 : java.lang.NullPointerException (객체 참조가 null 이면 메소드 실행 못한다.)
		String message = null;
		...
		// 숫자 외에 다른 문자 입력하면 Exception 발생 : java.lang.NullPointerException
