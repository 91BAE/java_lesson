...
// 읽어올 수 있는 텍스트 파일은 인코딩이 일치해야 한다.
// 워크 스페이스 UFT-8이면 텍스트 파일도 똑같은 UFT-8 형식만
//			MS949이면 텍스트 파일 ANSI 형식만
public class C67_ResourceClose {

	public static void main (String args[]) {
	// 파일 복사
//	String filename = "D:\\Iclass05\\자바테스트.txt";	// 읽기 : 존재하는 파일
	//String filename2 = "D:\\Iclass05\\자바테스트2.txt";	// 쓰기 : 존재하지 않는 파일
		
		
		// 파일 대화상자 사용하기
		String filename = fileDialogSave();		// 복사할 파일 지정해라.
		String filename2 = fileDialogSave();	// 저장할 파일은 폴더를 찾아가서 파일명을 직접 써라
	...
	public static String fileDialogSave() {
		JFrame f = new JFrame();	// 파일 대화상자를 시작 할 프레임 객체 생성
